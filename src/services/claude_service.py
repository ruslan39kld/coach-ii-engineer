...
ВАЖНО: Отвечай кратко и структурированно. Максимум 1500-2000 символов.
Если тема требует развёрнутого ответа — дай краткое резюме и предложи уточнить конкретный аспект.
Никогда не пиши ответы длиннее 2000 символов."""
