...
async def show_course_program_web(callback: CallbackQuery):
    ...
    text = (
        ...
        "*МОДУЛЬ 2: Фронтенд и интеграция ИИ (4 урока)*\n"
        ...
        "*МОДУЛЬ 3: Бэкенд и ИИ-сервисы (4 урока)*\n"
        "• Урок 9: Серверная часть на Python/FastAPI\n"
        "• Урок 10: RAG для веб-приложений\n"
        "• Урок 11: Аутентификация и безопасность\n"
        "• Урок 12: База данных и хранилище\n\n"

        "*МОДУЛЬ 4: Продвинутые техники (3 урока)*\n"
        "• Урок 13: Деплой веб-приложения\n"
        "• Урок 14: Оптимизация и производительность\n"
        "• Урок 15: Мультимодальный ИИ в вебе\n\n"

        "*МОДУЛЬ 5: Финальный проект (3 урока)*\n"
        "• Урок 16: Монетизация и продвижение\n"
        "• Урок 17: Финальный проект: планирование\n"
        "• Урок 18: Финальный проект: реализация\n\n"

        "*Всего:* 5 модулей, 18 уроков, 54 теста"
    )
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
